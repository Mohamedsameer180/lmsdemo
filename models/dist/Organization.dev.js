...
var organizationSchema = new mongoose.Schema({
  ...
  timezone: {
    type: String,
    "default": 'UTC',
    "enum": ['UTC', 'America/New_York', 'America/Los_Angeles', 'America/Chicago', 'Europe/London', 'Europe/Paris', 'Asia/Tokyo', 'Asia/Shanghai', 'Asia/Kolkata', 'Australia/Sydney']
  },
  locale: {
    type: String,
    "default": 'en-US',
  ...
  branding: {
    ...
    fontFamily: {
      type: String,
      required: true,
      "enum": ['Roboto, sans-serif', 'Open Sans, sans-serif', 'Lato, sans-serif', 'Montserrat, sans-serif', 'Poppins, sans-serif', 'Inter, sans-serif']
    }
  },
  policies: {
    courseAccess: {
